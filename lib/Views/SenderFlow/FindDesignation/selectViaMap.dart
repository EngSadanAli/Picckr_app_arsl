...
import 'package:picckr_app/Views/PickerFlow/Delivery/RealTimeTracking.dart';
...
class SelectViaMapG extends StatelessWidget {
  const SelectViaMapG({super.key});
  ...
  Widget build(BuildContext context) {
        ...
        children: [
          ...
          Padding(
            ...
            child: CustomButton(
              ...
              ontap: () {
                print('print');
                Get.off(ReciptientDetailScreen());
              },
              color: Color(0xFF847C3D),
              AppStyle: AppStyle(
                  color: Colors.white,
    ...
    Padding(
      ...
      child: InkWell(onTap: (){Get.off(SetRouteG());print('pressssssssssssssssssssssss');},
        child: Container(
        width: 36,
        height: 36,
