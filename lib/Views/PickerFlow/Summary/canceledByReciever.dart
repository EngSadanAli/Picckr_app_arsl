...
class CanceledByReciever extends StatelessWidget {
  const CanceledByReciever({super.key});
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            Padding(
              padding: EdgeInsets.symmetric(horizontal: 20.w),
              child:  AppTextFormField(controller: TextEditingController(), prefixIcon: Icon(Icons.border_color),toop: 4, botm: 0, hintText: 'Picckr distance too far')
              ,
            ),
