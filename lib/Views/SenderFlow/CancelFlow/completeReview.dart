...
class CanceledBySenderActivityG extends StatelessWidget {
  const CanceledBySenderActivityG({super.key});
                  ...
                  Wrap(
                    ...
                    children: [
                      ...
                      ChoiceChip(
                        ...
                        selected: false,backgroundColor:Theme.of(context).primaryColor ,
                        shape: RoundedRectangleBorder(
                          side:
                          BorderSide(width: 0.50, color: Theme.of(context).primaryColor),
                          borderRadius: BorderRadius.circular(8),
