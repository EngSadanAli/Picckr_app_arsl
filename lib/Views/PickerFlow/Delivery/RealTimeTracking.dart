...
import 'package:picckr_app/Views/PickerFlow/Delivery/RealTimeGotoDesignation.dart';
...
class RealTimeTrackingScreen extends StatelessWidget {
   RealTimeTrackingScreen({super.key});
                ...
                child:Column(children: [
                  ...
                  Column(crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      ...
                      CustomSizedBoxHeight(height: 10.h),
                      CustomButton(
                        title: 'Arrival at pick-up Address',
                        ontap: () {
                          Get.off(RealTimeTrackingGoToDesignation());
