...
import 'package:picckr_app/Views/SenderFlow/GuestAccess/BottombarScreens/Profile/BecamePicckR/ApprovelSuccess.dart';
...
class VehicleVerificationwaiting extends StatefulWidget {
  const VehicleVerificationwaiting({super.key});

  @override
  State<VehicleVerificationwaiting> createState() => _VehicleVerificationwaitingState();
}

class _VehicleVerificationwaitingState extends State<VehicleVerificationwaiting> {
  @override
  void initState() {
    Timer(Duration(seconds: 5),(){
Get.offAll(ApprovelVehicleVerificationSuccessScreen());
    });
