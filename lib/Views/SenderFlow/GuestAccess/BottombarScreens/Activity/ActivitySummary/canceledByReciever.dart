...
class CanceledByRecieverActivity extends StatelessWidget {
  const CanceledByRecieverActivity({super.key});
            ...
            Padding(
              ...
              child: CustomText(
                  textStyle: AppStyle(
                      ...
                      size: 14.sp)
                      .textPoppinsMedium,
                  title: 'Feedback from Cooper Septimus?'),
            ),
            CustomSizedBoxHeight(height: 10),
            Padding(
              padding: EdgeInsets.symmetric(horizontal: 20.w),
              child:  AppTextFormField(controller: TextEditingController(), prefixIcon: Icon(Icons.border_color),toop: 2, botm: 0, hintText: 'Picckr distance too far')
              ,
            ),
